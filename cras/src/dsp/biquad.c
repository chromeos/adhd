...
static void set_coefficient(struct biquad* bq,
                            double b0,
                            double b1,
                            double b2,
                            double a0,
...
static void biquad_highpass(struct biquad* bq,
                            double cutoff,
                            double resonance) {
  // Limit cutoff to 0 to 1.
  cutoff = max(0.0, min(cutoff, 1.0));
...
static void biquad_lowshelf(struct biquad* bq,
                            double frequency,
                            double db_gain) {
...
static void biquad_highshelf(struct biquad* bq,
                             double frequency,
                             double db_gain) {
  // Clip frequencies to between 0 and 1, inclusive.
  frequency = max(0.0, min(frequency, 1.0));
...
static void biquad_peaking(struct biquad* bq,
                           double frequency,
                           double Q,
                           double db_gain) {
  // Clip frequencies to between 0 and 1, inclusive.
