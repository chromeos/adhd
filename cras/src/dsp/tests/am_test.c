...
static void read_int16_mono(const char *input_path, size_t *size, float **data)
{
...
static void write_int16_mono(const char *output_path, const float *data,
			     const size_t size)
{
	int16_t *output = NULL;
...
static void test(const char *model_path, const char *input_path,
