...
# library. For an example, to generate the expected output of the
# computation modele "eq". Run the following commands:
#
# $ bazel build //cras/src/dsp/tests:eq_test
# $ bazel-bin/cras/src/dsp/tests/eq_test [golden_input] [expected_output]
#
