 ...
 *    out_sleep_correction_frames - Number of frames to adjust sleep time by.
 ...
 *    in_sleep_correction_frames - Same but for input devices.
...
struct audio_thread {
	...
	pthread_t tid;
	int started;
	int out_sleep_correction_frames;
	int in_sleep_correction_frames;
