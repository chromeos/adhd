 ...
 * start - Starts running device. If device supports this ops, device can be
 *         in CRAS_IODEV_STATE_OPEN state after being opened.
 *         If device does not support this ops, then device will be in
 *         CRAS_IODEV_STATE_NO_STREAM_RUN for output device, and
 *         CRAS_IODEV_STATE_NORMAL_RUN for input device.
