...
struct cras_rstream_config cras_rstream_config_init_with_message(
  ...
  cras_rstream_config_init(
      client, msg->stream_id, msg->stream_type, msg->client_type,
      msg->direction, msg->dev_idx, msg->flags, msg->effects, remote_fmt,
      msg->buffer_frames, msg->cb_threshold, aud_fd, client_shm_fd,
      msg->client_shm_size, buffer_offsets, &stream_config);
