...
/* Creates a volume curve with a specified max volume and range.
 * Args:
 *    max_volume - Maximum volume allowed in dB * 100. This value must be <= 0.
 *    range - Volume range in dB * 100.
 */
