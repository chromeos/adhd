...
def print_drc(conf, suffix: str, index: int, src: str, dst: str):
  print(drc_header_fmt.format(suffix=suffix, in_name=src, out_name=dst, ch1=2*index, ch2=2*index+1,
...
def print_eq(conf, suffix: str, index: int, src: str, dst: str):
  print(eq_header_fmt.format(suffix=suffix, in_name=src, out_name=dst, ch1=2*index, ch2=2*index+1))
